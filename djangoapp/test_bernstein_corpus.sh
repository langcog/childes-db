...
echo "Populating....."
python3 manage.py test_single_corpus --data_source CHILDES --collection_root /shared_hd2/childes-db/2020.1/candidate/childes.talkbank.org/data-xml --selected_collection Eng-NA  --corpus Bernstein
