...
echo "Populating....."
python3 manage.py populate_db --data_source CHILDES --collection_root /shared_hd2/childes-db-xml/2020.1/candidate/childes.talkbank.org/data-xml --collection Eng-NA
