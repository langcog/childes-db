...
echo "Populating....."
python3 manage.py test_single_transcript --data_source CHILDES --selected_collection Eng-NA --corpus_name Bernstein --xml_dir /shared_hd2/childes-db/2020.1/candidate/childes.talkbank.org/data-xml/Eng-NA/Bernstein/Children/Alice --fileid 010100.xml
